const requests = {
    ...
    fetchAHorrorMovies : `/discover/movie?api_key=${process.env.API_KEY}&with_genres=27`,
    fetchARomanceMovies : `/discover/movie?api_key=${process.env.API_KEY}&with_genres=10749`,
    fetchDocumentries : `/discover/movie?api_key=${process.env.API_KEY}&with_genres=99`,
}
